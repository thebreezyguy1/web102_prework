...
function addGamesToPage(games) {
    ...
    for (let index = 0; index < games.length; index++) {
        ...
        newDiv.innerHTML = `
            ...
            <p>Backers: ${games[index].backers}</p>`;
...
const displayStr = `A total of ${totalMoneyRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, 
    ${numberOfUnfundedGames} ${numberOfUnfundedGames <= 1 ? "game remains" : "games remain"} unfunded. We need your help 
